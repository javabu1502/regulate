...
function getAlternativeTechniques(technique: string): { label: string; href: string }[] {
  ...
  if (t.includes("breathing"))
    return [
      { label: "Grounding", href: "/techniques/grounding" },
      { label: "Somatic", href: "/techniques/somatic" },
    ];
  if (t.includes("grounding"))
    return [
      { label: "Breathing", href: "/techniques/breathing" },
      { label: "Body scan", href: "/techniques/body-scan" },
    ];
  if (t.includes("body"))
    return [
      { label: "Somatic", href: "/techniques/somatic" },
